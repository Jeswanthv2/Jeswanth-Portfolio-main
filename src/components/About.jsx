  ...
  return (
    <>
      ...
      <p ref={paragraphRef} className="mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]">
        I'm a skilled software developer with experience in  Front-End, and expertise in frameworks 
        like React,Data Base. I'm a quick learner and collaborate closely with clients to create efficient, 
